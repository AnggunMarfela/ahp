...
<div class="bg-white p-8 rounded-2xl shadow-lg w-full max-w-md">
    <h2 class="text-2xl font-bold mb-6 text-center text-gray-700">Tambah Siswa</h2>
    ...
    <form action="/siswa/store" method="POST" class="space-y-4">
        @csrf
